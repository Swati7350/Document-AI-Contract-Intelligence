"""Sidebar component — rendered on every page."""
...
.sb-nav-item{display:flex;align-items:center;gap:9px;padding:9px 12px;border-radius:10px;font-size:.82rem;font-weight:500;color:#374151;margin-bottom:4px;cursor:pointer;transition:background .15s;}
.sb-nav-item:hover,.sb-nav-item.active{background:#eff6ff;color:#1d4ed8;}
.sb-nav-item.active{font-weight:700;}
...
<div style="padding:0 14px 0;">
  <a href="https://lastpass-autofill-login-agent.onrender.com" target="_blank"
    ...
    🔐 LastPass Login Agent <span style="margin-left:auto;font-size:.62rem;font-weight:700;background:#dcfce7;color:#15803d;padding:2px 7px;border-radius:999px;">LIVE</span>
  </a>
  <a href="https://travel-agent-orchestration-and-whatsapp-integration.streamlit.app/" target="_blank"
     style="display:flex;align-items:center;gap:8px;padding:9px 12px;border-radius:10px;border:1px solid #e2e8f0;font-size:.8rem;font-weight:500;color:#374151!important;text-decoration:none!important;margin-bottom:6px;background:#f8fafc;">
    ✈️ Travel Agent <span style="margin-left:auto;font-size:.62rem;font-weight:700;background:#dcfce7;color:#15803d;padding:2px 7px;border-radius:999px;">LIVE</span>
  </a>
  <a href="https://ai-invoice-ocr.onrender.com/" target="_blank"
     style="display:flex;align-items:center;gap:8px;padding:9px 12px;border-radius:10px;border:1px solid #e2e8f0;font-size:.8rem;font-weight:500;color:#374151!important;text-decoration:none!important;margin-bottom:6px;background:#f8fafc;">
    🧾 Invoice OCR <span style="margin-left:auto;font-size:.62rem;font-weight:700;background:#dcfce7;color:#15803d;padding:2px 7px;border-radius:999px;">LIVE</span>
  </a>
</div>
<div class="sb-social">
